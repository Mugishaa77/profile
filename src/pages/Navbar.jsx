...
export default function Navbar({ toggleTheme, theme }) {
  return (
    <nav className="lusitana-bold">
      <img src={Mugisha} alt="Mugisha" className="light"/>
      <img src={MugishaDark} alt="Mugisha" className="dark" />
      <ul>
        <li>
          <NavLink
            to="/"
  ...
  {theme === 'light' ? (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
